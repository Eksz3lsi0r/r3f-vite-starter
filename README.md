# Kendama 3D Simulator
A physics-based Kendama simulator built with React Three Fiber, Rapier physics, and Vite.
...
3. On-screen touch controls appear automatically:
   ...
   - **↺ / ↻** — spin the ken
   - **THROW** (red button) — launch the tama upwards
...
| Arrow keys | Move ken |
| Q / E | Spin left / right |
| Touch buttons | Same as above on mobile |
